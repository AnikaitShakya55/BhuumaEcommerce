...
const CartProvider = (props) => {
  ...
  const fetchUrl = `https://beautybar-official-default-rtdb.firebaseio.com/BeautyBar/${userName}.json`;
  ...
  const value = {
    ...
    removeItem: removeCartItemHandler // Added the removeItem function to the context value
  }; 
