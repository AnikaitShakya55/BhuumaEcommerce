      ...
      <Container>
        ...
        <Row>
          <Col md={12} className="custom-cartoons-container">
            {/* <div className="custom-running-icon">
        ...
        <Row>
          <Col md={12}>
            <h2 className="additional-content-heading">Other Services</h2>
            <p className="additional-content-description">Explore our additional services:</p>
            <ul className="additional-services-list">
              <li>Makeup consultations</li>
              <li>Beauty workshops</li>
