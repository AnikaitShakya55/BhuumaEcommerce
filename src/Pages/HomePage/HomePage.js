    ...
    <div>
      <div className='front'>
        <Carousel interval={1000}>
          <Carousel.Item>
            {/* <a href='/store'><img src='https://cdn.vectorstock.com/i/500p/90/84/beauty-and-spa-day-advertising-banner-horizontal-vector-38059084.avif' className='frontimage'></img></a> */}
            <a href='/store'><img src='https://cdn.vectorstock.com/i/500p/90/14/beauty-and-spa-day-advertising-banner-horizontal-vector-37989014.avif' className='frontimage'></img></a>
          </Carousel.Item>

          <Carousel.Item>
            <a href='/store'><img src='https://www.100percentpure.com/cdn/shop/files/Refer_a_friend_Home_Page_Hero_Banner_-_Desktop_1920x.webp?v=1697486380' className='frontimage'></img></a>
          </Carousel.Item>

          <Carousel.Item>
            <a href='/store'><img src='https://www.dior.com/on/demandware.static/-/Library-Sites-DiorSharedLibrary/default/dw09ae364d/images/beauty/0-HOME/FRAGRANCES/2024/4-APRIL/A24_F095_LCP-CRUISE_GammeSansBoite_5550x2000_LCP.jpg' className='frontimage'></img></a>
          </Carousel.Item>
      ...
      <div className="image-container">
        ...
        <a href='https://www.elizabetharden.com/'>  <img src="https://images-static.nykaa.com/uploads/780cb137-7555-46ba-aa9f-e9533b216b46.jpg?tr=cm-pad_resize,w-300" alt="Image 2" /></a>
      ...
      <div className="newcontainer">
        ...
        <div className='giftstore'>
          {/* <img className='saving' src='https://images-static.nykaa.com/uploads/129930a1-0cac-4b58-b6cb-8c2f8f7cf580.gif?tr=cm-pad_resize,w-1200'></img> */}
      ...
      <div className="skincare-container">
        <a href='/store'>   <img src="https://images-static.nykaa.com/uploads/1e04ef67-6226-46c5-8c5e-8880fc24eefe.png?tr=cm-pad_resize,w-450" alt="Image 1" className='skincare' /></a>
        <a href='/store'>   <img src="https://images-static.nykaa.com/uploads/d712811a-a112-4217-a31d-eb1fa6d80dc4.png?tr=cm-pad_resize,w-450" alt="Image 1" className='skincare' /></a>
        <a href='/store'>   <img src="https://images-static.nykaa.com/uploads/eb7375c6-07cd-4430-bf14-f9522880063f.png?tr=cm-pad_resize,w-450" alt="Image 1" className='skincare' /></a>
        <a href='/store'>   <img src="https://images-static.nykaa.com/uploads/a2cb711c-ce25-4ffe-a5e0-ea1c71c624b3.png?tr=cm-pad_resize,w-450" alt="Image 1" className='skincare' /></a>
      </div>


      <div className="bestseller-container">

        <a href='/store'>   <img src="https://images-static.nykaa.com/uploads/0c6b07a9-b139-479b-8d6f-98d3774597f7.png?tr=cm-pad_resize,w-750" alt="Image 1" className='bestseller' /></a>
        <a href='/store'>   <img src="https://images-static.nykaa.com/uploads/57a0ce5b-c6b6-450d-b6f9-a44d21ab6cc5.png?tr=cm-pad_resize,w-750" alt="Image 1" className='bestseller' /></a>
        <a href='/store'>   <img src="https://images-static.nykaa.com/uploads/b9761ec3-b841-46b9-af60-c54e649895cf.jpg?tr=cm-pad_resize,w-750" alt="Image 1" className='bestseller' /></a>
      ...
      <div className='giftstore'>
        ...
        {/* <a href='/store'><img className='saving' src=''https://images-static.nykaa.com/uploads/3e9ed455-4e62-4f1a-b67d-1141859f30c6.jpg?tr=cm-pad_resize,w-1800></img></a> */}
      </div>
